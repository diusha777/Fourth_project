...
Уточнение условия:
- есть ежедневные поезда, а есть поезда, которые не ходят в определенные дни недели;
- время отправления и прибытия поездов не меняется;
- считаем что за каждым конкретным поездом закреплен только один, свой конкретный маршрут, в то время как одним маршрутом может ездить несколько поездов;
- пассажир не выбирает вагон и место в поезде, а выбирает только тип места (люкс, купе, плацкарт), система выбирает вагон и место случайным образом;
